...
/** 歌词控制器*/
@property (nonatomic, strong) QQLrcTVC *lrcTVC;
...
- (void) setUpForeImageView {
    ...
    self.foreImageView.layer.cornerRadius = self.foreImageView.width * 0.5;
...
- (void)sliderTap:(UITapGestureRecognizer *)sender{
    ...
    CGFloat scale = 1.0 * point.x / self.progressSlider.width;
